...
public class RMouseClicked extends MouseAdapter
{
	boolean isWhite;
	...
	RMouseClicked(boolean z, ColorLabel arrayLabelW[][], ColorLabel arrayLabelB[][], int a, int b, int x, JButton buttonW, JButton buttonB, JLabel subW, JLabel subB)
	{
		isWhite = z;
