...
public class BMouseClicked extends MouseAdapter
{
	boolean isWhite;
	...
	BMouseClicked(boolean z, ColorLabel arrayLabelW[][], ColorLabel arrayLabelB[][], int a, int b, int x, JButton buttonW, JButton buttonB, JLabel subW, JLabel subB)
	{
		isWhite = z;
